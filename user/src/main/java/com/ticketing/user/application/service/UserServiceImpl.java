...
public class UserServiceImpl implements UserService {
  ...
  @Override
  public Map<Long, String> getNicknamesByUserIds(GetNicknamesRequestDto requestDto) {
    // User 엔티티에서 닉네임 정보를 가져와서 Map으로 변환
    return userRepository.findNicknamesByUserIdsAndIsDeletedFalse(requestDto.userIds()).stream()
        .collect(Collectors.toMap(
            GetNicknameResponseDto::userId,
            GetNicknameResponseDto::nickname));
  }
}
